...
// //             <span className="text-2xl font-serif font-bold text-dark">THE ELEVENTH HOUR</span>
// //           </motion.a>
...
// //             ))}
// //             <motion.button
// //               className="bg-primary text-white px-6 py-2 rounded-full hover:bg-primary-light transition-colors duration-300"
// //               whileHover={{ scale: 1.05 }}
// //               whileTap={{ scale: 0.95 }}
// //             >
// //               Order Online
...
// //                   key={item.label}
// //                   href={item.href}
// //                   className="text-dark hover:text-primary transition-colors duration-300 py-2"
// //                   onClick={() => setIsOpen(false)}
// //                 >
// //                   {item.label}
// //                 </a>
// //               ))}
// //               <button className="bg-primary text-white px-6 py-2 rounded-full hover:bg-primary-light transition-colors duration-300 w-full">
// //                 Order Online
// //               </button>
// //             </div>
// //           </motion.div>
...
//                     key={item.label}
//                     href={item.href}
//                     className={`block px-4 py-3 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 ${
//                       activeSection === item.href
//                         ? 'text-primary font-semibold bg-primary/10'
//                         : 'text-gray-700 hover:text-primary hover:bg-gray-100'
//                     }`}
